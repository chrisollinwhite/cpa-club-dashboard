...
import { TrendingUp, Users, DollarSign, CheckCircle, XCircle, Target, Award } from 'lucide-react'
...
const mockMemberData = {
  name: "Chris White",
  email: "fundinginsidersshow@gmail.com",
  clients: 35,
  approved: 23,
  declined: 12,
  applications: 23,
...
function App() {
  ...
  const COLORS = ['#B8FF3C', '#1B2B4D', '#6B7280']
