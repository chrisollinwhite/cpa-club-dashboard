        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="bg-secondary text-primary px-4 py-2 rounded-full font-bold text-sm flex items-center gap-2">
                🏆 {memberData.memberLevel}
              </div>
              
              <button
                onClick={handleReferralClick}
                className="bg-secondary hover:bg-secondary/90 text-primary font-bold px-5 py-2.5 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl flex items-center gap-2 whitespace-nowrap"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="text-3xl font-bold text-secondary">{memberData.approved}</div>
        ...
        <div className="mb-8">
          <button
            onClick={handleReferralClick}
            className="w-full bg-secondary hover:bg-secondary/90 text-primary font-bold py-6 px-8 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]"
          >
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
          ...
          <div className="w-full bg-gray-200 rounded-full h-8 overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-secondary via-green-400 to-primary flex items-center justify-center text-sm font-bold text-white"
